		...
		<div class="container">
			...
			<div class="row">
				<div class="btn-group" role="group">
					<button id="" value="1" class="btn btn-primary b1">Химические науки</button>
					<button id="" value="2" class="btn btn-primary b1">Физические науки</button>
					<button id="" value="3" class="btn btn-primary b1">Геологические науки</button>
					<button id="" value="4" class="btn btn-primary b1">Биологические науки</button>
					<button id="" value="5" class="btn btn-primary b1">Исторические науки</button>
					<button id="" value="6" class="btn btn-primary b1">Филологические науки</button>
				</div>
			</div>
		</div>
        <?php
