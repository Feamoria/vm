...
INSERT INTO `event` (`id`, `Name`, `DateN`, `DateK`, `Desc_short`, `Desc`, `Doc`, `importance`, `latitude`, `longitude`, `create_user`, `create_date`) VALUES (2,'Создание отдела языка Институт','1970','','На момент формирования Института языка, литературы и истории отдел языка состоял из 8 человек: кандидаты филологических наук с.н.с. В.А. Сорвачева (1945–1977), Т.И. Жилина (1946 –1982), Е.С. Гуляев (1954–1977), м.н.с. Н.Н. Сельков (1945–1976) и ст. лаборанты Н.И. Лоскутова (1958–1991), Э.К. Павлова ','','',2,'','',2,'2024-03-29 10:24:44'),(3,'Вышел в свет «Краткий этимолог','1970','','«Краткий этимологический словарь коми языка» - это словарь, который даёт систематизированные сведения о происхождении коми слов, реконструируются древние формы слов и их значения. Авторы: В.И. Лыткин, Е.С. Гуляев. Работа внесла существенный вклад в развитие исторической лексикологии финно-угорских я','','',2,'','',2,'2024-04-01 08:46:37'),(4,'Вышел в свет «Краткий этимолог','1970','','«Краткий этимологический словарь коми языка» - это словарь, который даёт систематизированные сведения о происхождении коми слов, реконструируются древние формы слов и их значения. Авторы: В.И. Лыткин, Е.С. Гуляев. Работа внесла существенный вклад в развитие исторической лексикологии финно-угорских я','','',2,'','',2,'2024-04-01 10:01:48');
...
INSERT INTO `file_person` (`id`, `idFile`, `idPerson`) VALUES (5,8,5),(7,12,15),(8,14,17);
...
INSERT INTO `person_event` (`id`, `idEvent`, `idPerson`) VALUES (3,4,13);
...
INSERT INTO `sci_department_event` (`id`, `idSciDepartment`, `idEvent`) VALUES (3,17,3),(4,17,4);
...
INSERT INTO `sci_department_person` (`id`, `idSciDepartment`, `idPerson`) VALUES (4,17,17),(6,17,19);
...
CREATE TABLE `sci_theme` (
  ...
  `create_user` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COMMENT='Научная тематика';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sci_theme_event` (`id`, `idTheme`, `idEvent`) VALUES (3,8,2),(4,8,3),(5,8,4);
...
INSERT INTO `sci_theme_file` (`id`, `idFile`, `idSciTheme`) VALUES (5,7,8),(6,8,8),(7,9,8),(8,10,8),(9,11,8),(10,12,8),(11,13,8),(12,14,8);
...
INSERT INTO `sci_theme_pers` (`id`, `idTheme`, `idPers`) VALUES (4,8,5),(11,8,12),(12,8,13),(13,8,14),(14,8,15),(15,8,16),(16,8,17),(18,8,19);
...
INSERT INTO `tag_event` (`id`, `idTag`, `idEvent`) VALUES (2,10,2);
...
INSERT INTO `tag_file` (`id`, `idTag`, `idFile`) VALUES (5,10,7),(6,10,8),(7,10,9),(8,10,10),(9,10,11),(10,10,12),(11,10,13),(12,10,14);
...
INSERT INTO `tag_person` (`id`, `idTag`, `idPerson`) VALUES (5,10,5),(12,10,12),(13,10,13),(14,10,14),(15,10,15),(16,10,16),(17,10,17),(19,10,19);
...
INSERT INTO `user` (`id`, `role`, `FIO`, `login`, `pass`, `online`) VALUES (1,1,'Хохлов Роман Николаевич','hohlov','fdc7024e6ac8917bc1eb2a5878009c8047f805e28aef2acfb73b1a68165171482910cd186a9a47d1487eaeb03e98939c954e1c77aece4e02c459726199ac2f67','0000-00-00 00:00:00'),(2,2,'Мусанов Алексей','musanov','1b753e317766273dfef78e53d68e40462273b5d4679745add554c9b581d6e2dc19eee9713d69ad812061c72a45ac1a530b226246ba05c50506c5b742f296b9e1','2024-04-01 14:25:53'),(3,2,'Кирпичёв Алексей Николаевич','kirpichev','77734b923e3274df222894c6e03817d9873f59afc069b7471f8a259752457969b37880fa4bfa726f2861ea16bf1a32b040c2f1bf0c715f0069ae2bed08539a3e','0000-00-00 00:00:00');
...
-- Dump completed on 2024-04-01 17:26:22
