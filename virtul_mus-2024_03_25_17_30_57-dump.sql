...
CREATE TABLE `sci_department` (
  ...
  `owner` varchar(10) NOT NULL COMMENT 'Поле ID владельца (допускается значение индексов через запятую) (т.к. та или иная структура существовала определённый период)',
  `Date_create` date NOT NULL COMMENT 'дата создания',
  `Date_dectroy` date NOT NULL COMMENT 'дата ликвидации',
...
CREATE TABLE `sci_theme` (
  ...
  `create_user` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='Научная тематика';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tag` (`id`, `Name`, `create_date`, `create_user`) VALUES (1,'физика','2024-03-23 16:41:44',1),(2,'химия','2024-03-23 16:42:17',1),(3,'математика','2024-03-23 16:47:32',1),(4,'история','2024-03-23 16:49:55',1),(5,'литература','2024-03-23 16:55:07',1);
...
-- Dump completed on 2024-03-25 17:30:57
